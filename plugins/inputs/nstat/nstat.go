...
func (ns *Nstat) Gather(acc telex.Accumulator) error {
...
func (ns *Nstat) gatherNetstat(data []byte, acc telex.Accumulator) error {
...
func (ns *Nstat) gatherSNMP(data []byte, acc telex.Accumulator) error {
	metrics, err := loadUglyTable(data, ns.DumpZeros)
	if err != nil {
		return err
	}
...
func (ns *Nstat) gatherSNMP6(data []byte, acc telex.Accumulator) error {
...
func init() {
	inputs.Add("nstat", func() telex.Input {
		return &Nstat{}
	})
}
