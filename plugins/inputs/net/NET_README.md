...
Different platforms gather the data above with different mechanisms. telex uses the ([gopsutil](https://github.com/shirou/gopsutil)) package, which under Linux reads the /proc/net/dev file.
...
```
# All platforms
$ ./telex --config telex.conf --input-filter net --test
